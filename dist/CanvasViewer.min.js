...
angular.module("CanvasViewer",[]).directive("canvasViewer",["$window","$http","$timeout","$q",function(o,t,e,n){var i=new FormatReader;return{scope:{imageSource:"=src",overlays:"=overlays",title:"@title",options:"=options"},restrict:"E",template:'<div class="viewer-container"><canvas class="viewer" ng-mouseleave="canMove=false"ng-mousedown="mousedown($event)"ng-mouseup="mouseup($event)"ng-init="canMove=false"ng-mousemove="mousedrag($event,canMove)"></canvas><div class="title" ng-if="title!=null">{{title}}</div><div class="command" ng-if="options.controls.image"><div class="btn btn-info" title="Previous" ng-click="options.controls.numPage=options.controls.numPage-1" ng-hide="options.controls.totalPage==1"><i class="fa fa-minus"></i></div><div class="btn btn-info" ng-hide="options.controls.totalPage==1">{{options.controls.numPage}}/{{options.controls.totalPage}}</div><div class="btn btn-info" title="Next" ng-click="options.controls.numPage=options.controls.numPage+1" ng-hide="options.controls.totalPage==1"><i class="fa fa-plus"></i></div><div class="btn btn-info" title="Rotate left" ng-click="rotate(-1)" ng-hide="options.controls.disableRotate"><i class="fa fa-rotate-left"></i></div><div class="btn btn-info" title="Rotate right" ng-click="rotate(1)" ng-hide="options.controls.disableRotate"><i class="fa fa-rotate-right"></i></div><div class="btn btn-info" title="Zoom Out" ng-click="zoom(-1)" ng-hide="options.controls.disableZoom"><i class="fa fa-search-minus"></i></div><div class="btn btn-info" title="Reset" ng-click="resizeTo(\'page\')"><i class="fa fa-circle-o-notch"></i></div><div class="btn btn-info" title="Zoom In" ng-click="zoom(1)" ng-hide="options.controls.disableZoom"><i class="fa fa-search-plus"></i></div></div><div class="command" ng-if="options.controls.sound"><div class="btn btn-info" ng-click="stop()"><i class="fa fa-stop"></i></div><div class="btn btn-info" ng-click="play()"><i class="fa fa-play"></i></div></div></div>',link:function(t,a,s,l){function r(){null!=w&&(w.rendered?c():t.resizeTo(t.options.controls.fit))}function c(){if(null!=w&&w.rendered){var o=t.options,e=d.canvas,n=w.width*o.zoom.value/2,i=w.height*o.zoom.value/2;if(d.clearRect(0,0,e.width,e.height),d.save(),d.translate(y.x+n,y.y+i),d.rotate(o.rotate.value*Math.PI/180),d.translate(-n,-i),w.isZoom&&d.scale(o.zoom.value,o.zoom.value),o.controls.filmStrip&&1!=o.controls.totalPage){if(null!=w.images&&angular.forEach(w.images,function(o){d.drawImage(o,0,0,o.width,o.height),d.beginPath(),d.rect(0,0,o.width,o.height),d.lineWidth=.2,d.strokeStyle="#000000",d.stroke(),d.translate(0,o.height+15)}),null!=w.data){var a=0;angular.forEach(w.data,function(o){d.putImageData(o,y.x,y.y+a),d.beginPath(),d.rect(0,0,w.width,w.height),d.lineWidth=.2,d.strokeStyle="#000000",d.stroke(),a+=w.height+15,d.translate(0,a)})}}else null!=w.img&&(d.drawImage(w.img,0,0,w.width,w.height),d.beginPath(),d.rect(0,0,w.width,w.height),d.lineWidth=.2,d.strokeStyle="#000000",d.stroke()),null!=w.data&&(d.putImageData(w.data,y.x,y.y),d.beginPath(),d.rect(0,0,w.width,w.height),d.lineWidth=.2,d.strokeStyle="#000000",d.stroke());d.restore(),z.length>0&&angular.forEach(z,function(t){d.save(),d.translate(y.x+n,y.y+i),d.rotate(o.rotate.value*Math.PI/180),d.translate(-n,-i),d.scale(o.zoom.value,o.zoom.value),d.beginPath(),d.rect(t.x,t.y,t.w,t.h),d.fillStyle=t.color,d.globalAlpha=.4,d.fill(),d.lineWidth=1,d.strokeStyle=t.color,d.stroke(),d.restore()})}}function u(){t.$applyAsync(function(){var o=p.parentNode;d.canvas.width=o.clientWidth,d.canvas.height=o.clientHeight,c()})}function h(){return g.width!=p.parentNode.clientWidth&&(g.width=p.parentNode.clientWidth),g.height!=p.parentNode.clientHeight&&(g.height=p.parentNode.clientHeight),g}var p=a.find("canvas")[0],d=p.getContext("2d"),v=angular.element(a.find("div")[0])[0];directiveParentNode=v.parentNode.parentNode;var m=p.parentNode;d.canvas.width=m.clientWidth,d.canvas.height=m.clientHeight;var g={height:m.clientHeight,width:m.clientWidth},f={x:0,y:0},y={x:0,y:0},b={x:0,y:0},z=[],w=null;t.options=angular.merge({},{ctx:null,adsrc:null,zoom:{value:1,step:.1,min:.05,max:6},rotate:{value:0,step:90},controls:{toolbar:!0,image:!0,sound:!1,fit:"page",disableZoom:!1,disableMove:!1,disableRotate:!1,numPage:1,totalPage:1,filmStrip:!1},info:{}},t.options),t.options.ctx=d,t.$watch("imageSource",function(o){if(void 0!==o&&null!==o)if(t.options.zoom.value=1,t.options.rotate.value=0,f={x:0,y:0},y={x:0,y:0},"object"==typeof o)if(i.IsSupported(o.type)){var a=i.CreateReader(o.type,o);w=a.create(o,t.options,r,n,e,d)}else console.log(o.type," not supported !");else"string"==typeof o&&(w=i.CreateReader("image/jpeg").create(o,t.options,r,n,e))}),t.$watch("overlays",function(o,t){null!==o&&null!==t&&(z=[],angular.forEach(o,function(o){z.push(o)}),c())},!0),t.$watch("options.zoom.value",function(){t.options.controls.disableZoom||c()}),t.$watch("options.rotate.value",function(){t.options.controls.disableRotate||c()}),t.$watch("options.controls.fit",function(o){t.resizeTo(o)}),t.$watch("options.controls.filmStrip",function(o){o?(t.options.controls.disableMove=!0,t.options.controls.disableRotate=!0):(t.options.controls.disableMove=!1,t.options.controls.disableRotate=!1),w.refresh&&null!=w.refresh&&w.refresh()}),t.$watch("options.controls.numPage",function(o){t.options.controls.numPage<1&&(t.options.controls.numPage=1),t.options.controls.numPage>t.options.controls.totalPage&&(t.options.controls.numPage=t.options.controls.totalPage),null!=w&&(t.options.controls.filmStrip?(y.y=(t.options.controls.numPage-1)*-(w.height+15),c()):null!=w.refresh&&w.refresh())}),angular.element(p).bind("DOMMouseScroll mousewheel onmousewheel",function(e){var n=o.event||e,i=Math.max(-1,Math.min(1,n.wheelDelta||-n.detail));t.options.controls.filmStrip?(y.y+=50*i,y.y>15&&(y.y=15),w.images?y.y-w.height*t.options.zoom.value<-(w.height+15)*w.images.length*t.options.zoom.value&&(y.y=-(w.height+15)*w.images.length+w.height):y.y-w.height*t.options.zoom.value<-w.height*t.options.zoom.value&&(y.y=-w.height*t.options.zoom.value),t.$applyAsync(function(){c()})):i>0?t.zoom(1):t.zoom(-1),n.returnValue=!1,n.preventDefault&&n.preventDefault()}),angular.element(p).bind("mousedown",function(o){t.options.controls.disableMove||(t.canMove=!0,f.x=o.offsetX,f.y=o.offsetY)}),angular.element(p).bind("mouseup",function(o){t.options.controls.disableMove||(t.canMove=!1)}),angular.element(p).bind("mousemove",function(o){if(b.x=o.offsetX,b.y=o.offsetY,!t.options.controls.disableMove&&null!==w&&t.canMove){var e=o.offsetX,n=o.offsetY,i=e-f.x,a=n-f.y;y.x+=i,y.y+=a,c(),f.x=e,f.y=n}}),t.zoom=function(o){t.$applyAsync(function(){var e,n,i=0,a=0;w.isZoom?(e=w.width*t.options.zoom.value,n=w.height*t.options.zoom.value):(e=w.oldwidth,n=w.height),t.options.zoom.value+=t.options.zoom.step*o,t.options.zoom.value=Math.round(100*t.options.zoom.value)/100,t.options.zoom.value>=t.options.zoom.max&&(t.options.zoom.value=t.options.zoom.max),t.options.zoom.value<=t.options.zoom.min&&(t.options.zoom.value=t.options.zoom.min),null!=w.refresh&&w.refresh(),w.isZoom?(i=w.width*t.options.zoom.value,a=w.height*t.options.zoom.value):(i=w.width,a=w.height),y.x=y.x-(i-e)/2,y.y=y.y-(a-n)/2})},t.rotate=function(o){t.$applyAsync(function(){t.options.rotate.value+=t.options.rotate.step*o,(t.options.rotate.value<=-360||t.options.rotate.value>=360)&&(t.options.rotate.value=0),c()})};var x=function(){var o=d.canvas.width/2,e=0;e=o-w.width*t.options.zoom.value/2,f={x:e,y:0},y={x:e,y:0};var n=0;w.isImage?(centerY=d.canvas.height/2,e=o-w.width*t.options.zoom.value/2,n=centerY-w.height*t.options.zoom.value/2):e=o-w.width*t.options.zoom.value/2,f={x:e,y:n},y={x:e,y:n}};t.resizeTo=function(o){if(null!=d.canvas&&null!=w){var e=(t.options,d.canvas.height/w.height),n=d.canvas.width/w.width;switch(w.isZoom||(e*=t.options.zoom.value,n*=t.options.zoom.value),o){case"width":t.options.zoom.value=n;break;case"height":t.options.zoom.value=e;break;case"auto":t.options.zoom.value=Math.min(e,n,1);break;case"page":default:t.options.zoom.value=Math.min(e,n)}t.$applyAsync(function(){t.options.zoom.value=Math.round(100*t.options.zoom.value)/100,t.options.controls.fit=o,w.isZoom?(x(),c()):(null!=w.refresh&&w.refresh(),x())})}},t.play=function(){null!=t.options.adsrc&&t.options.adsrc.start(0)},t.stop=function(){null!=t.options.adsrc&&t.options.adsrc.stop(0)},t.$watch(h,function(){u()},!0)}}}]);